            ...
            <div className="col-span-1  rounded overflow-hidden">
                    ...
                    <ul className=' flex items-center flex-col gap-y-[10px] p-[10px] bg-white'>
                        {
                            ...
                            <li  className={` text-xl cursor-pointer w-full rounded border flex justify-start p-[5px] bg-orange-100 `}>
                                {category.title}
                            </li>
                            ))
                        }
                ...
                <div className=''>
                    ...
                    <ul className=' flex  flex-col gap-y-[10px] p-[10px] bg-white'>
                        ...
                        <Link to={getFilterUrl({price: price})}>
                            <li onClick={(e) => {e.stopPropagation(); handleClick(e)}} value="1000001-10000000" className={` cursor-pointer w-full rounded border flex justify-start p-[5px] ${"1100000-10000000" === price ? "bg-orange-100" : ""}`}>
                                1,000,001 - 10,000,000
                            </li>
                        </Link>
                        <Link to={getFilterUrl({price: price})}>
                        
                            <li onClick={handleClick} value="10000001-100000000" className={` cursor-pointer  w-full rounded border flex justify-start p-[5px] ${"11000000-100000000" === price ? "bg-orange-100" : ""}`}>
